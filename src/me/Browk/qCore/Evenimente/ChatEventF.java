...
public class ChatEventF implements Listener, Utile, Message {
    ...
    public void onChat(AsyncPlayerChatEvent e) {
        ...
        for(Player q : Bukkit.getOnlinePlayers()) {
            String rel_pref = "";
            if(Bukkit.getPluginManager().isPluginEnabled("Factions")) {
                FPlayer fPlayer = FPlayers.getInstance().getByPlayer(q);
                Faction faction = fPlayer.getFaction();
                FPlayer fPlayer2 = FPlayers.getInstance().getByPlayer(p);
                Faction targetFaction = fPlayer2.getFaction();
